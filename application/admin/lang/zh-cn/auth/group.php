...
return [ 
    ...
    'Can not change the parent to self' => '父組別不能是它的子組別', 
    'You can not delete group that contain child group and administrators' => '你不能刪除含有子組和管理員的組', 
    'The parent group exceeds permission limit'=> '父組別超出權限範圍',
