define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'frontend/credit/index',
                    add_url: 'frontend/credit/add',
                    edit_url: 'frontend/credit/edit',
                    del_url: 'frontend/credit/del',
                    table: 'credit',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'link', title: __('link'), sortable: true},
